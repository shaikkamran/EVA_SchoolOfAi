...
citymap=cv2.imread("./images/citymap_L.png")[:,:,::-1]
...
class Game(Widget):
    ...
    def get_state(self,no=image_crop_size//2):
        ...
        car_img_rot_angle=Vector(*self.car.velocity).angle((xx,yy))
        ...
        return obs.reshape(state_size)/255.0

    
    def calculate_reward(self,last_distance,last_reward,swap):
    ...
    def update(self, dt):
        ...
        global counter,done,episode_timesteps,obs
...
# We start the main loop over 500,000 timesteps
        ...
        distance,reward,swap,done=self.calculate_reward(last_distance,reward,swap)
        last_distance = distance
        print(f"iterations,distance,last_reward,swap{total_timesteps,distance,reward,swap}")

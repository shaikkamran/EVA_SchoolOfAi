...
class Actor(nn.Module):
    def __init__(self,image_size,max_action,orientation_dim):
        ...
        self.linear1=nn.Linear(1+orientation_dim,50)
...
class Critic(nn.Module):
    def __init__(self,image_size,action_dim):
        ...
        self.linear1_2=nn.Linear(1 + action_dim, 20)
        self.linear2_2=nn.Linear(20,1)
...
class TD3(object):
  ...
  def __init__(self,image_size,action_dim, max_action,orientation_dim):
    self.actor = Actor(image_size,max_action,orientation_dim).to(device)
    self.actor_target = Actor(image_size,max_action,orientation_dim).to(device)
